...
* @param {string} frame_code
* @param {string} format
* @returns {string}
*/
module.exports.run = function(frame_code, format) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passStringToWasm0(frame_code, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
const path = require('path').join(__dirname, 'framec_bg.wasm');
